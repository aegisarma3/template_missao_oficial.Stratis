...
//-------------------------------------------------------------------------------------------------------------------------
	case 9:		// ISTS
	{
		...
		_campAmmo      = [];
		_campStatic    = [["I_Mortar_01_F",-7,15,0,"CAF_AG_EEUR_R_AK47"],["I_HMG_01_high_F",15,15,0,"CAF_AG_EEUR_R_AK47"],["I_Mortar_01_F",15,-10,180,"CAF_AG_EEUR_R_AK47"],["I_HMG_01_high_F",-7,-10,180,"CAF_AG_EEUR_R_AK47"]];
		_campAddUnit   = [];
